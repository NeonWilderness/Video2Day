    ...
    $.fn.video2day = function(){
        var $videos = this,
            video2dayObj = {
                ...
                vidFrame: '<iframe width="{w}" height="{h}" src={p} frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>',
                vidParam : {
                    youtube:     '"http://www.youtube.com/embed/{v}"',
                    vimeo:       '"http://player.vimeo.com/video/{v}?byline=0&amp;portrait=0"',
                    vevo:        '"http://cache.vevo.com/m/html/embed.html?video={v}"',
